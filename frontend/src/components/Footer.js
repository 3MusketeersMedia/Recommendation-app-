    ...
    return (
        ...
        {/** Social Media Icons  **/}
            <ul className="list-unstyled list-inline text-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#738adb" class="bi bi-discord" viewBox="0 0 16 16">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" href="https://github.com/guyLee687/Recommendation-app-" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                ...
                <li className="list-inline-item mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="rgba(255,0,0, 1)" class="bi bi-youtube" viewBox="0 0 16 16">
